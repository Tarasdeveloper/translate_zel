            ...
            {!translating && (
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-stretch gap-2">
                        <select
                            className="flex-1 outline-none bg-white focus:outline-none border border-solid border-transparent hover:border-blue-300 duration-200 p-2 rounded cursor-pointer"
                            value={toLanguage}
